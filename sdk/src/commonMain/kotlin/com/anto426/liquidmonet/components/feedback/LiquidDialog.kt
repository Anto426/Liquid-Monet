...
private fun LiquidDialogLayer(
    ...
    AnimatedVisibility(
        ...
        enter = fadeIn(LiquidMotion.tween(performance, 180)),
        ...
        Box(
            ...
            Box(
                modifier = Modifier
                    ...
                    .animateEnterExit(
                        enter = LiquidMotion.dialogEnter(performance),
                        exit = LiquidMotion.dialogExit(performance)
                    )
            ) {
                LiquidDialogPanel(
                    title = title,
...
private fun LiquidDialogPanel(
    ...
    Column(
        ...
        CompositionLocalProvider(
            LocalLiquidGlassContentBackdrop provides backdrop,
