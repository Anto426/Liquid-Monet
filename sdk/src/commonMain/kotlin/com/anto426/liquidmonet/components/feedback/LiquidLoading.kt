...
private fun LiquidLoadingDots(
    ...
    val animate = LocalLiquidGlassPerformance.current.animateFunctionalContent
    ...
    val infiniteTransition = if (animate) {
        rememberInfiniteTransition(label = "DotsBounceAnim")
    } else {
        null
    }
    val dot1Offset by if (infiniteTransition != null) {
    ...
    val dot2Offset by if (infiniteTransition != null) {
        infiniteTransition.animateFloat(
            initialValue = 0f,
            targetValue = 1f,
            animationSpec = infiniteRepeatable(
    ...
    val dot3Offset by if (infiniteTransition != null) {
        infiniteTransition.animateFloat(
            initialValue = 0f,
            targetValue = 1f,
            animationSpec = infiniteRepeatable(
...
private fun LiquidLoadingPulse(
    ...
    val infiniteTransition = if (animate) {
        rememberInfiniteTransition(label = "PulseAnim")
    } else {
        null
    }
    val pulseProg by if (infiniteTransition != null) {
        infiniteTransition.animateFloat(
            initialValue = 0f,
            targetValue = 1f,
            animationSpec = infiniteRepeatable(
