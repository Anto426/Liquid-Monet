...
private fun LiquidRangeSliderImpl(
    ...
    LiquidInputNormalization.positive(trackHeight, "LiquidRangeSlider trackHeight")
    LiquidInputNormalization.positive(thumbSize, "LiquidRangeSlider thumbSize")
    ...
    BoxWithConstraints(
        ...
        val startDragAnimation = remember(animationScope, valueRange, visibilityThreshold, performance) {
            DampedDragAnimation(
        ...
        val endDragAnimation = remember(animationScope, valueRange, visibilityThreshold, performance) {
            DampedDragAnimation(
                animationScope = animationScope,
                performance = performance,
    ...
    Box(
        Modifier
            ...
            .liquidGlassDynamic(
                ...
                performance = performance,
                effectProgress = { animation.pressProgress },
                layerBlock = {
