...
internal class InverseLayerScope : GraphicsLayerScope {
    ...
    private var matrixRotation = Float.NaN
    private var matrixScaleX = Float.NaN
    private var matrixScaleY = Float.NaN
    ...
    fun reset() {
        ...
        // Keep the allocated matrix and its coefficient cache between backdrop draws.
        // All public layer values above still reset before evaluating the next layer block.
    }
    ...
    private fun DrawTransform.inverseTransformAtTopLeft(
        ...
        if (matrixRotation == rotationZ && matrixScaleX == scaleX && matrixScaleY == scaleY) {
            transform(matrix)
            return
        }
