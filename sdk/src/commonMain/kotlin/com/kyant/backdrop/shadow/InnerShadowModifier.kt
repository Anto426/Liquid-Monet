...
internal class InnerShadowNode(
    ...
    private var recordedShadow: InnerShadow? = null
    ...
    override fun ContentDrawScope.draw() {
        ...
        if (shadowLayer != null) {
            ...
            if (outline is Outline.Generic || previous == null || previous.offset != shadow.offset ||
                previous.color != shadow.color || recordedOutline != outline || recordedSize != size ||
