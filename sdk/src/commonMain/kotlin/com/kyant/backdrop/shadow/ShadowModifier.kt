...
internal class ShadowNode(
    ...
    private var recordedSize: IntSize? = null
    ...
    override fun ContentDrawScope.draw() {
        ...
        if (shadowLayer != null) {
            ...
            val previous = recordedShadow
            if (outline is Outline.Generic || previous == null || previous.radius != shadow.radius ||
                previous.offset != shadow.offset || previous.color != shadow.color ||
                recordedOutline != outline || recordedSize != shadowSize || recordedDensity != density.density) {
    ...
    private fun DrawScope.configurePaint(shadow: Shadow) {
        ...
        val radius = shadow.radius.toPx()
        if (previousBlurRadius != radius) {
            paint.blur(radius)
            previousBlurRadius = radius
        }
    }
}
