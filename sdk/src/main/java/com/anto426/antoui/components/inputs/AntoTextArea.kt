...
/**
 * AntoTextArea - Multi-line Optical Liquid Glass Text Area for notes, comments, and descriptions.
 */
@Composable
fun AntoTextArea(
    value: String,
    ...
    val inputHighlight = rememberAntoControlHighlight()
    ...
    BasicTextField(
        ...
        modifier = modifier
            ...
            .graphicsLayer(antoControlLayerBlock(enabled, inputHighlight) ?: {})
