...
/**
 * State holder for AntoDatePicker.
 */
@Stable
class AntoDatePickerState(
...
@Composable
fun rememberAntoDatePickerState(
    initialDate: Calendar = Calendar.getInstance()
): AntoDatePickerState {
    return remember { AntoDatePickerState(initialDate) }
}

/**
 * AntoDatePicker - Inline Liquid Glass Calendar Component.
 */
@Composable
fun AntoDatePicker(
    state: AntoDatePickerState,
...
/**
 * AntoDatePickerField - Liquid Glass Date Input Trigger Field.
 */
@Composable
fun AntoDatePickerField(
    ...
    Box(
        ...
        Row(
            ...
            Row(
                ...
                Icon(
                    imageVector = AntoIcons.Calendar,
