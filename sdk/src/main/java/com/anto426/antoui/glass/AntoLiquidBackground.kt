...
/**
 * Visual effects supported by AntoLiquidBackground.
 */
enum class AntoBackgroundEffect {
...
/**
 * AntoLiquidBackground - High-performance dynamic Material 3 background synthesizer.
 *
 ...
 */
@Composable
fun AntoLiquidBackground(
    modifier: Modifier = Modifier,
    effect: AntoBackgroundEffect = AntoBackgroundEffect.Aurora,
    isDark: Boolean = isSystemInDarkTheme(),
    monetSeed: AntoMonetSeed? = null,
    ...
    val infiniteTransition = rememberInfiniteTransition(label = "AntoBackgroundMotion")
