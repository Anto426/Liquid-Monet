package com.anto426.antoui.theme.monet
...
object AntoMonetPresets {
    val Sapphire = AntoMonetSeed(
...
object AntoMonetEngine {

    fun generateColorScheme(
        context: Context,
        darkTheme: Boolean,
        useSystemDynamic: Boolean = true,
        customSeed: AntoMonetSeed = AntoMonetPresets.Sapphire
    ): ColorScheme {
    ...
    private fun extractSystemMonetSeed(context: Context, fallback: AntoMonetSeed): AntoMonetSeed {
    ...
    private fun AntoMonetSeed.toMaterial3ExpressiveScheme(darkTheme: Boolean): ColorScheme {
